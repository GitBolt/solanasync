...
import { Box, Flex, Heading, Text, Icon, Center, Button, FormControl, FormLabel, Input, Divider, useMediaQuery, Spinner } from '@chakra-ui/react';
  ...
  return (
    <>
      ...
      {!workshop || !workshop.location ?
        <Center>
          <Spinner  width="10rem" height="10rem" color="blue.200" thickness='0.3rem'/>
          </Center> : <Flex align="center" justify="center" alignItems="center" justifyContent="center" mt={check600 ? "1rem" : "4rem"}>
